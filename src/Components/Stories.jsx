        ...
        <div className="mt-7">
          <Splide options={splideOptions}>
            {news.map((val, i) => {
              return (
                <SplideSlide key={i}>
                  <div className="relative grid items-center shadow shadow-slate-200 ring-1 ring-slate-200 rounded-lg w-full h-full pb-2">
                    <div className="flex items-center justify-center mb-2">
                      <img
                        src={val.img}
                        alt={`img/story/${i}`}
                        className="w-auto h-auto object-cover rounded-tr-lg rounded-tl-lg"
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-center px-4 w-full mt-2">
                      <a
                        role="button"
                        href={val.url}
                        target={"_blank"}
